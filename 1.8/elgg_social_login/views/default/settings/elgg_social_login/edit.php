...
?>
	...
	<h3 style="border-bottom: 1px solid #CCCCCC;margin:10px;">Notes</h3>
	<ul style="list-style:circle inside;margin-left:25px;">
		...
		<li>This plugin is tested on a <strong>default</strong> installation of Elgg without any extra add-ons,</li>
		<li>This plugin is for peoples who don't fancy the idea of having a middleman webservice for this purpose,</li>
		<li>As an open source project and alpha stage plugin, We Appreciate Your <strong>Feedback!</strong></li> 
	</ul> 
	...
	<p>
		&nbsp;&nbsp;&nbsp;
		We recommend to first read the <img src="<?php echo $assets_base_url; ?>external-link-icon.jpg" /> <b><a href="<?php echo $plugin_base_url ?>help/index.html#settings" target="_blank" >User Guide</a></b>. 
	</p>
	...
	<p>
		&nbsp;&nbsp;&nbsp;
		We also highly recommend to run the <img src="<?php echo $assets_base_url; ?>external-link-icon.jpg" /> <b><a href="<?php echo $plugin_base_url ?>diagnostics.php?url=http://www.example.com" target="_blank" >Plugin Diagnostics</a></b>. 
	</p>
